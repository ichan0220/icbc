...
class activities_category extends app_crud_controller{
    ...
    function delete_image ($id, $id_image){
        $image = "SELECT * FROM activities_category WHERE id = ?";
        ...
        $sql = "UPDATE activities_category SET file_name = '',orig_name = null,uri = null WHERE id = ?";
