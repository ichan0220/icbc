...
class activities extends app_crud_controller{
    ...
    function view(){
        ...
        $this->_data['main_cat'] = $this->_model('main_category')->_all_smenu();
        $this->_data['area_details'] = $fa = $this->_model('activities')->detail_area($title);
        $l = $this->lang->fetch_language();
        $this->_data['lang'] = $l;
        ...
        $this->_data['label'] = '<h2 class="culture-title"><a href="'.site_url('web/activities').'">'.l('activities').'</a> <a href="'.site_url('web/activities').'/'.$cat.'"><span>/'.$cat.'</span></a></h2>';
