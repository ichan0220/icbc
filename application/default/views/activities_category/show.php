...
<form enctype="multipart/form-data" action="<?php echo current_url() ?>" method="post" class="ajaxform">
    ...
    <fieldset>
        ...
        <div>
            <label class="mandatory"><?php echo l('Name (Chinese)') ?></label>
            <input type="text" value="<?php echo set_value('name_cn') ?>" name="name_cn" placeholder="Name (Chinese)" />
        </div>
    ...
    <!-- <fieldset>
           ...
           <div>
              <div class="thumbs thumbnail">
                  <img src="<?php echo base_url('timthumb.php?src=')?><?php echo base_url('data/area_category/image/original') . '/' . $image['file_name'] ?>&w=100&h=100" alt=""/>
